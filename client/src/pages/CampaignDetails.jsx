...
const CampaignDetails = () => {
    ...
    const {getDonations, donate, contract, address, getCampaigns, setCampaigns} = useStateContext();
    ...
    const handleDelete = async () => {
        try {
            ...
            const indexToDelete = currentCampaigns.findIndex(campaign => campaign.pId === state.pId);
                    ...
                    <div className="flex-[2] flex flex-col gap-[40px]">
                        <div>
                            ...
                            <div className="mt-[20px]">
                                <p className="font-epilogue text-[16px] text-justify leading-[26px] font-normal text-[#808191]">{state.description}</p>
                            </div>
